    ...
    <div class="mask " style="background-color: rgba(0, 0, 0, 0.7);">
        <div class="d-flex justify-content-center align-items-center h-100 p-5">
            <div class="text-white">
                ...
                <a class="btn btn-outline-light btn-lg m-2" href="seniors.php"
                   role="button" rel="nofollow" target="_blank"><img src="assets/paw.png" alt=""><h2>Support our Seniors</h2></a>
                <a class="btn btn-outline-light btn-lg m-2" href="all_pets.php"
                   role="button" rel="nofollow" target="_blank"><img src="assets/paw.png" alt=""><h2>Show all</h2></a>
